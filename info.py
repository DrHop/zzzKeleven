...
PORT = serial.Serial('COM5', 9600, timeout=None)
...
class ReadStream(threading.Thread):
    ...
    def run(self):
        PORT.write(
            '\x5A\x0B\x5A\x01\x5A\x08\x5A\x0C\x5A\x0D\x5A\x03\x5A\x05\x5A\x09\x5A\x13\x5A\x16\x5A\x17\x5A\x1A\x5A\x1C\x5A\x21\xF0')
